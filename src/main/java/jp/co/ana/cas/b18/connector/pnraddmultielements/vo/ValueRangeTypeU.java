...
public class ValueRangeTypeU   {
  ...
  public ValueRangeTypeU measureUnitQualifier(String measureUnitQualifier) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    ValueRangeTypeU valueRangeTypeU = (ValueRangeTypeU) o;
    return Objects.equals(this.measureUnitQualifier, valueRangeTypeU.measureUnitQualifier);
  }

  @Override
  public int hashCode() {
    return Objects.hash(measureUnitQualifier);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ValueRangeTypeU {\n");
