...
import jp.co.ana.cas.b18.connector.pnraddmultielements.vo.ApplicationType1;
import jp.co.ana.cas.b18.connector.pnraddmultielements.vo.LocationType;
import jp.co.ana.cas.b18.connector.pnraddmultielements.vo.UserID;
...
public class AMASecurityHostedUser   {
  ...
  private ApplicationType1 application;
  ...
  public AMASecurityHostedUser application(ApplicationType1 application) {
  ...
  */
  ...
  public void setApplication(ApplicationType1 application) {
    this.application = application;
  }
